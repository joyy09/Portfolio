    ...
    <>
      ...
      <div className="about-container">
        <div className='about-text'>
          ...
          <div className="about">I am a pre-final year undergrad student at LNMIIT, pursuing my B.Tech degree in Electronics ans Communication Engineering (ECE) with an overall CGPA of 8.55.</div>
          ...
          <div className='div-social'>
            ...
            <a className='social-container' target="_blank" href='https://github.com/joyy09' ><svg xmlns="http://www.w3.org/2000/svg" height='30' width='30' fill="#8750F7" className="bi bi-github social" viewBox="0 0 16 16">
